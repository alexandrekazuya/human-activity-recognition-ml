...
def load_feature_arrays(features_path="data/features.npy", y_path="data/y_features.npy", participants_path="data/participants_features.npy"):
...
if __name__ == '__main__':
    ...
    np.save("results/plots/features_scenario_a_602020.npy", scenario_a_602020)
    ...
    np.save("results/plots/features_scenario_a_933.npy", scenario_a_933)
    ...
    np.save("results/plots/features_scenario_b_602020_n_components.npy", scenario_b_602020)
    ...
    np.save("results/plots/features_scenario_b_933_n_components.npy", scenario_b_933)
    ...
    np.save("results/plots/features_scenario_c_602020_top15_idx.npy", scenario_c_602020)

    scenario_c_933 = create_scenario_relieff_top15(
        split_933["X_train"], split_933["X_val"], split_933["X_test"], 
        split_933["y_train"], split_933["y_val"], split_933["y_test"]
    )
    np.save("results/plots/features_scenario_c_933_top15_idx.npy", scenario_c_933)
